...
export default function HomeScreen({ navigation }) {
  ...
  const navigateToScreen = (screenName) => {
    ...
    const navigationMap = {
      ...
      'NFL': () => navigation.navigate('EliteInsights', { screen: 'NFL' }),
      'PlayerMetrics': () => navigation.navigate('EliteInsights', { screen: 'PlayerMetrics' }),
      'PlayerDashboard': () => navigation.navigate('EliteInsights', { screen: 'PlayerDashboard' }),
      'Fantasy': () => navigation.navigate('EliteInsights', { screen: 'Fantasy' }),
      
      // "Success Metrics & Elite Picks" screens - navigate to stack screens (RevenueCat protected)
      'Predictions': () => navigation.navigate('SuccessMetrics', { screen: 'Predictions' }),
      'ParlayArchitect': () => navigation.navigate('SuccessMetrics', { screen: 'ParlayArchitect' }),
      'ExpertSelections': () => navigation.navigate('SuccessMetrics', { screen: 'ExpertSelections' }),
      'SportsWire': () => navigation.navigate('SuccessMetrics', { screen: 'SportsWire' }),
      'Analytics': () => navigation.navigate('SuccessMetrics', { screen: 'Analytics' }),
    };
