...
const HomeScreen = () => {
  ...
  const quickAccessItems = [
    ...
    { 
      title: 'NHL Trends', 
      icon: '🏒', 
      onPress: () => navigation.navigate('EliteInsights', { screen: 'NHLTrends' }),
      color: '#06b6d4'
    },
    ...
    { 
      ...
      icon: '📊', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'PlayerMetrics' }),
      color: '#10b981'
    },
    { 
      title: 'Match Analytics',
      icon: '⚔️', 
      onPress: () => navigation.navigate('EliteInsights', { screen: 'MatchAnalytics' }),
      color: '#f59e0b'
    },
    { 
      title: 'Fantasy Hub',
      icon: '🏆', 
      onPress: () => navigation.navigate('EliteInsights', { screen: 'FantasyHub' }),
      color: '#ec4899'
    },
    { 
      title: 'Player Dashboard',
      icon: '👤', 
      onPress: () => navigation.navigate('EliteInsights', { screen: 'PlayerDashboard' }),
      color: '#3b82f6'
    },
    ...
    { 
      ...
      icon: '🤖', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'AdvancedAnalytics' }),
      color: '#06b6d4'
    },
    { 
      title: 'Parlay Architect',
      icon: '🏗️', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'ParlayArchitect' }),
      color: '#f59e0b'
    },
    { 
      title: 'Expert Selections',
      icon: '🎯', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'ExpertSelections' }),
      color: '#ec4899'
    },
    { 
      title: 'Predictions Outcome',
      icon: '🔮', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'PredictionsOutcome' }),
      color: '#8b5cf6'
    },
    ...
    { 
      title: 'Sports Wire',
      icon: '📡', 
      onPress: () => navigation.navigate('SuccessMetrics', { screen: 'SportsWire' }),
      color: '#6366f1'
    },
  ];
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.gridContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('SuccessMetrics')}
          >
